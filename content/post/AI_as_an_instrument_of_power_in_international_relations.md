...
- ###### Mass surveillance
From facial recognition to social scoring, AI-based technologies are redefining the scale and accuracy of public (and private) surveillance. The reason AI-based technologies are making such an impact on surveillance is because of their self-learning capabilities, allowing systems to continuously improve and minimizing error with every new data entry. Alongside privacy concerns and numerous ethical questions, the mere fact that AI-enabled infrastructures are built could potentially allow domestic or foreign malicious actor to use them for purposes detrimental to specific groups of people. 
